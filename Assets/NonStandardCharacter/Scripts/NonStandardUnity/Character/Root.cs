...
using CallbackContext2 = InputAction.CallbackContext;
#else
using CallbackContext = System.Boolean;
using CallbackContext2 = UnityEngine.Vector2;
#endif
...
namespace NonStandard.Character {
	...
	public class Root : MonoBehaviour {
		...
		public void SetFireAction(CallbackContext context) {
#if USE_INPUTSYSTEM
...
#else
			if (context) {
				FireInput = float.PositiveInfinity;
			} else {
				FireInput = 0;
			}
#endif
...
#else
			if (context) {
				JumpInput = float.PositiveInfinity;
			} else {
				JumpInput = 0;
			}
#endif
		...
		public void SetMove(CallbackContext2 context) {
#if USE_INPUTSYSTEM
